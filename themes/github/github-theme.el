;;; github.el --- Github Color Theme for Emacs
...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face ((t (:foreground ,base03 :italic nil))))
   ...
   `(font-lock-function-name-face ((t (:foreground ,base0E))))
   `(font-lock-keyword-face ((t (:foreground ,base08))))
   `(font-lock-negation-char-face ((t (:foreground ,base0B))))
   `(font-lock-preprocessor-face ((t (:foreground ,base08))))
   ...
   `(font-lock-type-face ((t (:foreground ,base0C))))
   `(font-lock-variable-name-face ((t (:foreground ,base09))))
   ...
   `(enh-ruby-op-face ((t (:foreground ,base08))))
   ...
   `(haskell-operator-face ((t (:foreground ,base08))))
   ...
   ;; Tuareg
   `(tuareg-font-lock-governing-face ((t (:foreground ,base08))))
   `(tuareg-font-lock-module-face ((t (:foreground ,base0C))))
   `(tuareg-font-lock-constructor-face ((t (:foreground ,base0E))))
   `(tuareg-font-lock-operator-face ((t (:foreground ,base08))))
   `(tuareg-font-lock-error-face ((t (:foreground ,baseerror))))
