...
The format is suitable for `font-lock-add-keywords' and `font-lock-remove-keywords'."
  `((,(concat "# *\\(@" yard-tags-re "\\)") 1 'yard-tag-face t)
    ...
    (,(concat "# *@!?" yard-tags-with-names-re   " \\(\\(\\sw\\|\\s_\\)+\\)") 1 'yard-name-face t)
    (,(concat "# *@!?" yard-tags-with-names-re   " \\[.+?\\] \\(\\(\\sw\\|\\s_\\)+\\)") 1 'yard-name-face t)
    (,(concat "# *@!?" yard-tags-with-options-re " \\(\\(\\sw\\|\\s_\\)+\\)") 1 'yard-name-face t)
    (,(concat "# *@!?" yard-tags-with-options-re " \\(\\sw\\|\\s_\\)+ \\[.+?\\] \\(\\(:\\|\\sw\\|\\s_\\)+\\)") 2  'yard-option-face t)))
